...
from pygat_myself.utils import load_data, accuracy
from pygat_myself.models import GAT, spGAT
...
def train(epoch):
    ...
    writer.add_scalar("loss train",loss_train.item(),epoch)
        # tensorboard --logdir=./pygat_myself/loss_train_logs --port=6008 注意dir的文件夹位置
...
for epoch in range(args.epochs):
    loss_values.append(train(epoch)) # 训练模型
